...
public class Twentygmcoin {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//span[text()='20 gram' and @data-p='gold-coins-weight-20gms,m']")).click();
	WebElement coin = driver.findElement(By.id("short_desc_goldWt"));
